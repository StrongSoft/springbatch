...
(
    ...
    CONSTRAINT `fk_student_teacher` FOREIGN KEY (`teacher_id`) REFERENCES `teacher` (`id`)
...
insert into teacher (name, subject) value ('kim','Math');
insert into teacher (name, subject) value ('lee','English');

select *
from teacher;

insert into study (name, subject, teacher_id)
values ('test1', 'Math', 1);
insert into study (name, subject, teacher_id)
values ('test2', 'Math', 1);
insert into study (name, subject, teacher_id)
...
insert into study (name, subject, teacher_id)
values ('test1', 'English', 1);
insert into study (name, subject, teacher_id)
values ('test2', 'English', 2);
insert into study (name, subject, teacher_id)
values ('test3', 'English', 2);